          ...
          <div className={styles.termsSection}>
            ...
            <div className={styles.termsBox}>
              <div className={styles.textarea}>
                ...
                <p>
                  1. 이용자는 본 약관에 동의함으로써 회사와 이용 계약을
                  체결합니다.
                </p>
                <p>2. 회사는 이용자의 신청을 승인함으로써 계약이 성립됩니다.</p>
                <p className={styles.termsTitle}>제3조 (서비스의 제공)</p>
                <p>
                  회사는 이용자에게 다음과 같은 서비스를 제공합니다: 정보 제공,
                  상품 판매 등
                </p>
                <p className={styles.termsTitle}>제4조 (이용자의 의무)</p>
                <p>
                  이용자는 본 약관 및 관련 법령을 준수하여야 합니다. 타인의
                  권리를 침해하거나 불법 행위를 해서는 안 됩니다.
                </p>
                ...
                <p>
                  회사는 필요에 따라 본 약관을 변경할 수 있으며, 변경 시
                  공지합니다.
                </p>
