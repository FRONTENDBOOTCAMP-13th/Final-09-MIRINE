...
export default function CartItem({ data }: { data: { name: string; volume: number; quantity: number; price: number } }) {
  return (
    <li className={styles.cart_item}>
      ...
      <div className={styles.bottom_section}>
        <div className={styles.cnt_section}>
          <button className={styles.cnt_dec_btn}>
