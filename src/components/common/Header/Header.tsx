      ...
      <div className={styles.inner}>
        ...
        <ul className={styles.nav_left}>
          <li>
            <Link
              href="/mirine"
              className={pathname === "/mirine" ? styles.active : ""}
            >
              미리내
            </Link>
          </li>
          <li>
            <Link
              href="/mirine-test"
              className={pathname === "/mirine-test" ? styles.active : ""}
            >
              미리내 테스트
            </Link>
          </li>
          <li>
            <Link
              href="/perfumes"
              className={pathname === "/perfumes" ? styles.active : ""}
            >
              향수
            </Link>
          </li>
          <li>
            <Link
              href="/aroma-shooter"
              className={pathname === "/aroma-shooter" ? styles.active : ""}
            >
              아로마슈터
            </Link>
          </li>
        ...
        <h1 className={styles.logo}>
          <Link href="/">
            <Image
              ...
              src="/logo/logo-black-mobile.svg"
              alt="로고"
              width="66"
              height="16"
            />
        ...
        <ul className={styles.nav_right}>
          ...
          <li>
            <Link
              href="/shopping-cart"
              className={pathname === "/shopping-cart" ? styles.active : ""}
            >
              장바구니
            </Link>
        ...
        >
          <Image
            src="/icon/Icon-right-toggle-menu.svg"
            alt="모바일 토글 메뉴"
            width="24"
            height="24"
          />
